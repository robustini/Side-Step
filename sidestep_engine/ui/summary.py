...
def _show_rich(
    ...
    hints.append("  3. Export for ComfyUI:  ", style="dim")
    hints.append(f"sidestep export {final_dir}\n")
    hints.append("  4. Generate music with the adapter via the Gradio UI\n", style="dim")
...
def _show_plain(
    ...
    print(f"\n  Export for ComfyUI .. sidestep export {final_dir}", file=sys.stderr)
